...
class QC_trimmomatic(base_luigi_task):
    ...
    def run(self):
        ...
        if not exists(self.PE2):
            ...
            cmdline = "java -jar {trimmomatic_jar} PE -threads {thread} {input1} {input2} {tmp1} {outdir}/{PE1_id}.unpaired.fq.gz {tmp2} {outdir}/{PE2_id}.unpaired.fq.gz ILLUMINACLIP:{trimmomatic_dir}/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:50  ;  fastp -i {tmp1} -I {tmp2} -o {ofile1} -O {ofile2} -n 0".format(
